...
//                .collect(Collectors.toList());
    ...
    public static Region getRegionOfITDepartment() throws Exception {
          return getAllDepartments().stream()
                ...
                .findFirst().orElseThrow(() -> new Exception("Department not fount"))
...
//                .get();
    ...
    public static Long getMaxSalaryInAmericasRegion() {
        return getAllEmployees().stream()
                .filter(employee ->
                        employee.getDepartment().getLocation().getCountry().getRegion().getRegionName().equals("Americas"))
                .max(Comparator.comparing(Employee::getSalary))
                .get().getSalary();
    }
...
//                && employee.getDepartment().getDepartmentName().equals("Salaes"))
//                .findFirst().get();
